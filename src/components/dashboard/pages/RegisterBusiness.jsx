        ...
        try {
            ...
            addToast(
                error?.response?.data?.message || 'Something went wrong!',
                {
                    ...
                    autoDismissTimeout: 5000, // Set auto dismissal timeout (5 seconds)
                    transitionDuration: 300,  // Set transition duration
                }
            );
                        ...
                        <div className='flex flex-col   justify-start items-center middle-container-left w-full m-3 rounded-md'>
                            <div className='bg-white flex justify-between items-center w-full rounded-md p-2 entity-register-container' >
                                <div className='flex  address-input justify-center items-center    '  >
                                    ...
                                    <div className='flex flex-col justify-between items-start mx-2  w-full' >
                                        ...
                                        {errorsMessage && <ErrorMessage errors={errorsMessage} field="contact_tel" />}  
                                ...
                                <div className='flex address-input justify-center items-center   ' >
                                    ...
                                    <div className='flex flex-col justify-between items-start mx-2 w-full' >
                                        ...
                                        {errorsMessage && <ErrorMessage errors={errorsMessage} field="email" />}  
                                    </div>
                                ...
                                <div className='flex address-input lex address-input justify-center items-center  ' >
                                    ...
                                    <div className='flex flex-col justify-between items-start mx-2 w-full' >
                                        ...
                                        {errorsMessage && <ErrorMessage errors={errorsMessage} field="name" />}  
                            ...
                            <div className='bg-white w-full mt-3 rounded-md px-8 py-2 ' >
                                {!registered && <div className='flex flex-col my-3  w-3/5 form-width'>
                                    <div className='flex justify-between business-image mobile-fit  ' >
                                        <div className='flex flex-col w-full mr-1' >
                                            ...
                                            {errorsMessage && <ErrorMessage errors={errorsMessage} field="color_code" />}  
                                            ...
                                            <div className='flex flex-col'  >
                                                ...
                                                {errorsMessage && <ErrorMessage errors={errorsMessage} field="category" />}  
                                ...
                                {!isRegistered && phoneNumber.length === 10 && <span role="img" aria-label="cross mark" class="react-emojis">❌</span>}
                                        ...
                                        {errorsMessage && <ErrorMessage errors={errorsMessage} field="momo_tel" />}  
                                    </span>
                                    ...
                                    <div className='flex justify-between mobile-fit '>
                                        <div className='flex flex-col w-full'  >
                                            ...
                                            <select disabled required value={rewardType} onChange={setrewardTypeHandleChange} className='rounded border'  >
                                                <option value='cashback' >cashback</option>
                                                <option value='cashback'>cashback</option>
                                                <option value='points'>points</option>
                                            </select>
                                            {errorsMessage && <ErrorMessage errors={errorsMessage} field="reward_type" />}  
                                        </div>
                                    ...
                                    <div className='flex justify-between business-image mobile-fit  ' >
                                        <div className='flex flex-col w-full mr-1' >
                                            <span className='flex flex-col' >
                                                ...
                                                {errorsMessage && <ErrorMessage errors={errorsMessage} field="reward_percentage" />}  
                                            ...
                                            <span className='flex flex-col' >
                                                ...
                                                {errorsMessage && <ErrorMessage errors={errorsMessage} field="password" />}  
                                            </span>
