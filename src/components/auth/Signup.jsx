...
import { User, Phone, Lock, Mail, Eye, EyeOff, CheckCircle, ArrowRight, AlertCircle } from 'lucide-react';
          ...
          <div className="w-full max-w-md">
            <div className="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
              <div className="px-6 py-8 text-center">
                ...
                <p className="text-gray-600 mb-6">Welcome aboard, {formData.fullName}!</p>
