                ...
                <div className='flex flex-col my-3  w-3/5 form-width'>
                    <div className='flex justify-between business-image mobile-fit  ' >
                        <div className='flex flex-col w-full mr-1' >
                            ...
                            <input type="text" className='' placeholder=' Business name' value={firstName} onChange={firstNameHandleChange}  ></input>
                            <label className='' >
                                Color code
                            </label>
                            <input type="text" className='' placeholder=' Color code' value={firstName} onChange={firstNameHandleChange}  ></input>
                            <span className='flex flex-col' >
                                <label>
                                    Contact tel
                                </label>
                                <input type="text" className='' placeholder=' contact tel' value={lastName} onChange={lastNameHandleChange}></input>
                            </span>
                        </div>
                    ...
                    <div className='flex justify-between mobile-fit '>
                        <div className='flex flex-col w-1/2'  >
                            ...
                            <select required value={displayName} onChange={displayNameHandleChange} className='rounded border'  >
