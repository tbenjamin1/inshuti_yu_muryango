...
export const fetchAsynProviders = createAsyncThunk('tranx/fetchAsynProviders', async () => {

    const response = await axios.get(`https://ussdbackendautomation.jalikoi.rw/providers`)
    return response.data;
})
...
const transactionsSlice = createSlice({
    ...
    extraReducers: {
        ...
        [fetchAsynProviders.fulfilled]: (state, { payload }) => {
            return {
                ...state, isLoading: false, allUssdProviders: payload
            };
        },
