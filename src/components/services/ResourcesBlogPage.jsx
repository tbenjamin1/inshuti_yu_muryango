...
import { Search, BookOpen, Heart, Brain, Users, Calendar, Tag, ArrowLeft, ExternalLink, Clock, User, Share2, Bookmark } from 'lucide-react';
  ...
  const resources = [
    {
      ...
      excerpt: 'Learn about anxiety symptoms, causes, and effective coping strategies.',
    ...
    },
    {
      ...
      excerpt: 'Discover simple daily practices that can transform your mental wellbeing.',
      category: 'wellness',
      readTime: '6 min',
      date: '2025-01-12',
      ...
      `,
      resources: [
        { name: 'Wellness Recovery Action Plan', url: 'https://mentalhealthrecovery.com' },
    ...
    },
    {
      ...
      excerpt: 'How to create meaningful connections and find your support community.',
      category: 'community',
      readTime: '7 min',
      date: '2025-01-10',
      ...
      resources: [
        ...
        { name: 'NAMI - National Alliance on Mental Illness', url: 'https://nami.org' }
      ]
    },
    {
      id: 4,
      ...
      resources: [
        ...
        { name: 'UCLA Mindful Awareness Research Center', url: 'https://marc.ucla.edu' }
      ]
    },
    {
      id: 5,
      title: 'Sleep Hygiene: The Foundation of Mental Health',
      excerpt: 'Understand the critical role of sleep in maintaining mental wellness.',
      category: 'wellness',
      readTime: '9 min',
      date: '2025-01-05',
    ...
    },
    {
      ...
      excerpt: 'Essential resources for immediate mental health support and crisis intervention.',
      category: 'mental-health',
      readTime: '4 min',
      date: '2025-01-03',
        ...
        <div className="max-w-7xl mx-auto px-4 py-6">
          <div className="flex items-center gap-4 mb-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-2xl font-bold text-gray-800">Resources & Blog</h1>
                <p className="text-gray-600 text-sm">Mental health resources and wellness guides</p>
              </div>
            </div>
          </div>
          ...
          <div className="resource-detail">
            ...
            <div className="relative mb-6">
              ...
              <div className="absolute top-4 right-4 bg-white/90 backdrop-blur-sm rounded-full px-3 py-1 flex items-center gap-2">
                ...
                <span className="text-sm font-medium text-gray-700">{selectedResource.readTime}</span>
              </div>
            </div>

            {/* Title and Meta */}
            <div className="mb-6">
              <h1 className="text-2xl font-bold text-gray-800 mb-3">{selectedResource.title}</h1>
              ...
              <div className="flex flex-wrap items-center gap-4 text-sm text-gray-600 mb-4">
                ...
                <div className="flex items-center gap-1">
                  ...
                  <span>{formatDate(selectedResource.date)}</span>
                </div>
              </div>
              ...
              <div className="flex flex-wrap gap-2 mb-4">
                {selectedResource.tags.map((tag, index) => (
                  <AntTag key={index} color="pink" className="rounded-full">
                    {tag}
                  </AntTag>
                ))}
              </div>
