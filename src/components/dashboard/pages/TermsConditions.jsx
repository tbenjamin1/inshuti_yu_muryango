        ...
        <div className='flex justify-center items-center border terms-container' >
            <div className='flex flex-col justify-center w-1/2 bg-white p-3 rounded-lg terms-condition ' >
                ...
                <div className='terms-description' >
                    By proceeding with the registration process for JaliKoi's Entities Cashback Donation Program, entities acknowledge and agree to comply with the following terms and conditions:

                    Entities registering for the Cashback Donation Program must confirm their eligibility, falling within social groups categories such as churches, NGOs, clubs, and any other communal organizations. Providing accurate and up-to-date information during the registration process is paramount, with JaliKoi reserving the right to verify the legitimacy and eligibility of each registered entity.

                    Upon registration, entities are authorized to receive cashback donations from JaliKoi users who opt to direct their earned cash back towards supporting a cause. Entities commit to utilizing these funds for the stated purpose and in alignment with their missions. Transparency is expected, with entities providing regular updates on fund utilization and impact to supporters.
                    Entities must maintain an accurate and up-to-date profile, including details about their activities, goals, and contact information. This profile will be visible to JaliKoi users expressing interest in supporting the entity's cause.
                    ...
                    Entities are expected to adhere to JaliKoi's community guidelines, policies, and all applicable laws and regulations. Respecting donor privacy and adhering to JaliKoi's privacy policy are integral to the program.
                    Entities must furnish accurate and valid account details to receive funds from JaliKoi users. Financial transparency is paramount, requiring entities to maintain accurate records of funds received and disbursed.
                    In the event of disputes between entities and donors, JaliKoi reserves the right to mediate and facilitate a resolution aligning with the principles of fairness and transparency.
                    JaliKoi retains the right to terminate the registration of entities found in violation of these terms and conditions. Such actions will be taken judiciously to uphold the integrity of the program.
                    To accommodate evolving needs and circumstances, JaliKoi may update these terms and conditions, with entities promptly informed of any changes.
                    By proceeding with the registration process, entities affirm their understanding and commitment to these terms and conditions. JaliKoi reserves the right to take necessary actions, including the termination of entity accounts, to address any violations.
