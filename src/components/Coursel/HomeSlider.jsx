    ...
    const images = [
        {
            ...
            description: "Creating judgment-free environments where women can share, heal, and grow together"
        },
        {
            id: 2,
            ...
            description: "Empowering women to prioritize their mental health through mindfulness and self-compassion"
        },
        {
            id: 3,
            ...
            description: "Building connections that celebrate diversity and foster mutual support among women"
        },
        {
            id: 4,
            ...
            description: "Guiding women toward emotional balance, resilience, and lasting mental wellness"
        }
    ];
            ...
            <div className="max-w-6xl mx-auto px-6">
                ...
                <div className="text-center mb-12">
                    <h2 className="text-4xl font-bold text-gray-800 mb-4">
                        Nurturing <span className="bg-gradient-to-r from-rose-400 via-pink-400 to-purple-400 bg-clip-text text-transparent">Women's Wellness</span>
                    </h2>
                    <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                        Every woman deserves to feel heard, supported, and empowered on her mental health journey. 
                        Together, we create spaces where healing and growth flourish.
                    </p>
                </div>
                ...
                <div className="relative">
                            ...
                            {images.map((image, index) => (
                                ...
                                >
                                    <img
                                        ...
                                        className="w-full h-full object-cover"
                                    />
                                    <div className={`absolute inset-0 bg-gradient-to-r from-rose-400/20 to-purple-400/20 transition-opacity duration-300 ${
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-12">
                        ...
                        <div className="text-center p-6 bg-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 border border-pink-100 hover:border-pink-300">
                            ...
                            <h3 className="text-xl font-semibold text-gray-800 mb-3">Workshops & Events</h3>
                            <p className="text-gray-600 text-sm mb-4 leading-relaxed">
                                Attend empowering workshops on mindfulness, self-care, and mental wellness strategies.
                            </p>
                            <button className="text-pink-600 font-medium hover:text-pink-700 transition-colors duration-200">
                                Learn More →
                            </button>
                        ...
                        <div className="text-center p-6 bg-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 border border-pink-100 hover:border-pink-300">
                            ...
                            <h3 className="text-xl font-semibold text-gray-800 mb-3">Skill Development</h3>
                            <p className="text-gray-600 text-sm mb-4 leading-relaxed">
                                Learn coping strategies, emotional regulation, and resilience-building techniques.
                            </p>
                            <button className="text-pink-600 font-medium hover:text-pink-700 transition-colors duration-200">
                                Learn More →
                            </button>
                        ...
                        <div className="text-center p-6 bg-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 border border-pink-100 hover:border-pink-300">
                            ...
                            <p className="text-gray-600 text-sm mb-4 leading-relaxed">
                                Your confidentiality is protected with our secure, judgment-free environment.
                            </p>
                            <button className="text-pink-600 font-medium hover:text-pink-700 transition-colors duration-200">
                                Learn More →
                            </button>
                        ...
                        <div className="text-center p-6 bg-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 border border-pink-100 hover:border-pink-300 md:col-span-2 lg:col-span-1">
                            ...
                            <h3 className="text-xl font-semibold text-gray-800 mb-3">Resources & Blog</h3>
                            <p className="text-gray-600 text-sm mb-4 leading-relaxed">
                                Access our comprehensive library of mental health resources, articles, and wellness guides.
                            </p>
                            <button className="text-pink-600 font-medium hover:text-pink-700 transition-colors duration-200">
                                Learn More →
                            </button>
                    ...
                    <div className="text-center mt-12">
                        <div className="bg-gradient-to-r from-rose-400 via-pink-400 to-purple-400 p-8 rounded-2xl shadow-xl text-white">
                            ...
                            <p className="text-lg mb-6 opacity-95">
                                You don't have to face your challenges alone. Join our supportive community today.
                            </p>
