...
import { Menu, X, Phone, MapPin, Mail, User, LogIn } from 'lucide-react';
...
const NewNavBar = () => {
    ...
    return (
        <div>
            ...
            <nav className={`bg-white/95 backdrop-blur-lg shadow-lg w-full fixed top-0 left-0 right-0 z-40 border-b border-gray-200 transition-all duration-300 ${isScrolled ? 'shadow-xl' : ''}`}>
                {/* Desktop Layout */}
                        ...
                        <div className="bg-gradient-to-r from-purple-500 to-purple-500 text-white px-6 w-full flex justify-between items-center">
                            ...
                            <div className="space-y-1">
                                <div className="flex items-center space-x-2 text-sm group">
                                    <Phone size={14} className="text-green-400 group-hover:text-green-300 transition-colors" />
                                    <span className="group-hover:text-green-100 transition-colors">+250 787 435 731</span>
                                </div>
                                <div className="flex items-center space-x-2 text-sm group">
                            ...
                            <div className="flex space-x-2">
                                {isLoggedIn ? (
                                    <div className="bg-white/10 px-4 py-2 rounded-lg">Profile</div>
                                ) : (
                                    <>
                                        <a
                                            href="/login"
                        ...
                        <>
                            ...
                            <div className="absolute top-full left-0 right-0 bg-white shadow-2xl z-40 lg:hidden transform transition-all duration-300 animate-in slide-in-from-top-2">
                                ...
                                <div className="bg-gradient-to-r from-purple-400 via-purple-400 to-blue-400 text-white py-6 px-6">
                                    <h3 className="font-bold mb-4 text-base">Contact Information</h3>
                                    <div className="space-y-3">
                                        <div className="flex items-center space-x-3 text-sm group">
                                            <MapPin size={16} className="text-yellow-300 group-hover:text-yellow-200 transition-colors" />
                                            <span>IMA House, Kicukiro, Kigali</span>
                                        </div>
                                        <div className="flex items-center space-x-3 text-sm group">
                                            <Phone size={16} className="text-green-300 group-hover:text-green-200 transition-colors" />
                                            <span>+250 787 438 701</span>
                                        </div>
                                        <div className="flex items-center space-x-3 text-sm group">
                                            <Mail size={16} className="text-blue-300 group-hover:text-blue-200 transition-colors" />
                                            <span>highBytes@highroup.rw</span>
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex space-x-3 mt-6">
                                        {isLoggedIn ? (
                                            <div onClick={closeMobileMenu} className="bg-white/20 px-6 py-3 rounded-lg text-sm font-semibold flex-1 text-center">
                                                Profile
                                            </div>
                                        ) : (
                                            <>
                                                <a
                                                    href="/login"
                                                    className="flex items-center justify-center space-x-2 bg-white/20 hover:bg-white/30 px-6 py-3 rounded-lg text-sm font-semibold transition-all duration-300 flex-1 hover:scale-105"
                                                    onClick={closeMobileMenu}
                                                >
                                                    <LogIn size={16} />
                                                    <span>Login</span>
                                                ...
                                                <a
                                                    href="/register"
                                                    className="flex items-center justify-center space-x-2 bg-white text-purple-600 hover:bg-gray-100 px-6 py-3 rounded-lg text-sm font-semibold transition-all duration-300 flex-1 hover:scale-105"
                                                    onClick={closeMobileMenu}
                                                >
                                                    <User size={16} />
                                                    <span>Register</span>
